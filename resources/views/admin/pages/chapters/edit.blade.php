			...
			<div class="card-body">
				<form class="form-horizontal form-bordered" id="edit-chapter-form" action="{{ action('ChapterController@update',[$chapter->id])}}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $chapter->title}}">
							@if ($errors->has('title'))
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							<textarea name="description" data-plugin-markdown-editor rows="10">{{ $chapter->description}}</textarea>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<select  class="form-control populate" name="course_id">
								@foreach($courses as $course)
								<?php $selected = ($course->id == $chapter->course_id)?true:false;?>
					...
					<div class="form-group row">
						...
						<div class="col-lg-5">
							<ul class="thumd-list">
								@if(count($chapter->trailer_video))
									@foreach($chapter->trailer_video as $trail_video)
									<li> 
